...
class ResNet50(nn.Module):
    def __init__(self, pretrained_weights=None):
        ...
        self.predict_start = nn.Sequential(nn.Linear(2048, 1024), nn.ReLU(), nn.Linear(1024, 2))
        self.predict_end = nn.Sequential(nn.Linear(2048, 1024), nn.ReLU(), nn.Linear(1024, 2))
